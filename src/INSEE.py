...
lgr = logging.getLogger('INSEE')
lgr.setLevel(logging.DEBUG)
fh = logging.FileHandler('INSEE.log')
...
def _category_job(anchor):
    ...
    def retrieve_postrequests(url):
        webpage2 = misc_func.urlopen(url)
    ...
    webpage1 = misc_func.urlopen(_url)
...
class INSEE(object):
    ...
    def update_categories_db(self):
        ...
        lgr.info('update_categories_db() got called')
        lgr.info('Retrieving http://www.bdm.insee.fr/bdm2/index.action')
        webpage = misc_func.urlopen('http://www.bdm.insee.fr/bdm2/index.action')

...
from dlstats.fetchers.ecb import ECB, ECB_Data, ContinueRequest
...
Load files with httpie tools:
    ...
    http http://sdw-wsrest.ecb.int/service/data/EXR/M.NOK.EUR.SP00.A > ecb-M.NOK.EUR.SP00.A-data.xml
...
def mock_upsert_dataset(self, dataset_code):
    ...
    self.insee_data = Mock_Data(dataset=dataset,

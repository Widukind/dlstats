...
from pymongo.errors import ConnectonFailure
from . import configuration
from dlstats import lgr
try:
    mongo_client = MongoClient(**configuration['MongoDB'])
except ConnectonFailure: # Be careful. MongoClient don't throw that exception in the latest versions of pymongo

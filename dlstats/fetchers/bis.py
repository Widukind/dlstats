# -*- coding: utf-8 -*-
"""
:Fetcher: Locational banking statistics
:Code: LBS-DISS
:Series: 27 375
:File: https://www.bis.org/statistics/full_bis_lbs_diss_csv.zip
:File size: 7 197Ko / 32 890Ko (zip)
:run time: 153.032 seconds

-----------------------------------------

:Fetcher: Consolidated banking statistics
:Code: CBS
:Series: 112 261
:File: https://www.bis.org/statistics/full_bis_cbs_csv.zip
:File size: 10 924Ko / 80 646Ko (zip)
:run time: 602.750 seconds (519.091 seconds avant update metas)

-----------------------------------------

:Fetcher: Debt securities statistics
:Code: DSS
:Series: 203 710
:File: https://www.bis.org/statistics/full_bis_debt_sec2_csv.zip
:File size: 19 997Ko / 247 793Ko (zip)
:run time: 1447.602 seconds (1243.534 seconds avant update metas)

-----------------------------------------

:Fetcher: Credit to the non-financial sector
:Code: CNFS
:Series: 938
:File: https://www.bis.org/statistics/full_bis_total_credit_csv.zip
:File size: 33Ko / 8Ko (zip)
:run time: 6.589 seconds

-----------------------------------------

:Fetcher: Debt service ratios for the private non-financial sector
:Code: DSRP
:Series: 66
:File: https://www.bis.org/statistics/full_bis_dsr_csv.zip
:File size: 1 705Ko / 365Ko (zip)
:run time: 0.299 seconds 

-----------------------------------------

:Fetcher: Property prices - selected series
:Code: PP-SS
:Series: 228
:File: https://www.bis.org/statistics/full_bis_selected_pp_csv.zip
:File size: 224Ko / 43Ko (zip)
:run time: 1.390 seconds

-----------------------------------------

:Fetcher: Property prices - long series
:Code: PP-LS
:Series: 23
:File: https://www.bis.org/statistics/full_bis_long_pp_csv.zip
:File size: 36Ko / 12Ko (zip)
:run time: 0.177 seconds 

-----------------------------------------

:Fetcher: Effective exchange rate indices
:Code: EERI
:Series: 175
:File: https://www.bis.org/statistics/full_bis_eer_csv.zip
:File size: 675Ko / 159Ko (zip)
:run time: 2.034 seconds
"""
